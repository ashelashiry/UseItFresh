...
/// Owner, 14 Sep: "when you click on scan … it always opens the scanner then
/// you have to close it and pick receipt or barcode … it shouldn't open right
/// away … user should pick."
///
/// The Scan tab stops opening the camera by itself: it shows its four tiles.
/// The Fridge tile's camera still recognises a receipt, so a receipt works
/// from either Receipt or Fridge.
void buildStarterEditFlow(App app) {
  // On load it only clears a half-finished photo map, as before; the
  // navigation to the camera is what goes.
