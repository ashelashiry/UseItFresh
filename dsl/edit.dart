...
/// The receipt review shows the receipt itself (shop, where, when, total) at
/// the top, under "Tap a line to fix it", with Fix.
void buildStarterEditFlow(App app) {
  app.editPage(ff.Pages.scanReviewPage, (page) {
    page.ensureInsertedAfter(
      ff.Pages.scanReviewPage.widgets.byKey('Text_j8zpcm8j').single,
      CustomWidget(
        widgetName: 'ReceiptHeader',
        name: 'ScanReviewReceipt',
        arguments: {},
      ),
    );
  });
