...
void buildStarterEditFlow(App app) {
  app.editPage(ff.Pages.barcodeScanPage, (page) {
    page.mutateNode(ff.Pages.barcodeScanPage.widgets.byPath('BarcodeScanPage.body[0]').single, (FFNode root) {
      void walk(FFNode n, int depth) {
        if (n.type == FFWidgetType.Button) {
          print('BTN ${n.key} ${n.props.button.toProto3Json()} PAD ${n.props.padding.toProto3Json()}');
        }
        if (n.type == FFWidgetType.Icon) {
          print('ICON ${n.key} ${n.props.icon.toProto3Json()}');
        }
        if (n.type == FFWidgetType.Container && n.children.length == 1 && n.children.first.type == FFWidgetType.Icon) {
          print('BACKBOX ${n.key} ${n.props.container.toProto3Json()}');
        }
