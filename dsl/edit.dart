...
/// Design guide v4, Recipes: the title leads the page, so the app bar goes
/// (Home, Scan and Inventory have none). `visible: false` on an AppBar does not
/// reach codegen, so it is removed instead.
void buildStarterEditFlow(App app) {
  final recipes = ff.Pages.recipesPage;
  app.editPage(recipes, (page) {
    page.ensureRemoved(recipes.widgets.byKey('AppBar_tkuj2pby').single);
  });
}
