...
|---|---|---|---|---|---|
| 14 | 2026-09-15 | `build-14-ios` | `1KC9rTt68T2jV1CtJB2O` | `2026-09-14.3` | Everything in build 13 (hybrid design, all new features) plus storage removal moving its food, What you used showing no activity, household join wording. Build 13 showed nothing new on the owner's phone (possibly the older build was installed); 14 replaces it. Not yet tested; build 11 stays the fallback |
